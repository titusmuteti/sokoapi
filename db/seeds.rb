...
database_url = 'postgres://sokodb_meip_user:6pB7j0RU5FkgvwAx0xcoGKSOHCki6bTJ@dpg-clgcg06g1b2c73a7k000-a/sokodb_meip'
...
products.each do |product_data|
    ...
    existing_product = Product.find_by(title: product_data[:title])
